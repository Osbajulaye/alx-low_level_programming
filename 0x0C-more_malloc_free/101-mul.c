...
/**
 * _calloc - allocates (size * nmemb) bytes and set to 0
...
/**
 * _straight - check if string 's' is composed only of digits
 * @s: string to check
...
/**
 * strmul - multiply two numbers as strings
 * @a: first number
 * @b: second number
...
/**
 * main - multiply two nubers form the command line and print the result
 * @argc: argument count
 * @argv: argument list
 * Return: 0 if succcesful, 98 if failure
 */
